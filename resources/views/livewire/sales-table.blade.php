...
@endif
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 13h6m-6 4h6M3 7h18M5 7v12h14V7" />
  </svg>
  <span class="text-lg font-semibold">Aucune Suivi trouvée</span>
  <p class="text-sm text-gray-400">Essayez d’ajouter une nouvelle suivi pour commencer.</p>
  </div>
  </div>
  </div>
                @endforelse
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 transform transition-all duration-300 scale-95" id="editModalContent">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="date" wire:model="editDateSuivi" id="editDateSuivi" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"  min="{{ date('Y-m-d') }}">
