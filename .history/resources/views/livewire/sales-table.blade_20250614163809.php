<div class="relative">
            ...
            <div class="flex flex-col space-y-4">
                @forelse($suivis as $suivi)
                    <div class="flex p-4 border rounded-md bg-white shadow-sm">
                        <div class="mr-4">
                            <div
                                class="h-12 w-12 rounded-full bg-primary-100 flex items-center justify-center text-primary-600 font-medium mr-2">
                        ...
                        <div class="flex-1">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    <button
                                        onclick="showDeleteModal({{ $suivi->id }}, '{{ addslashes($suivi->client->full_name) }}')"
                                        class="p-1 rounded-md text-gray-400 hover:text-red-600">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <div class="flex space-x-2">
                                    <button
                                        ...
                                        onclick="window.open('tel:{{ $suivi->client->phone }}')">
                                        <i class="fas fa-phone mr-1.5"></i> Appeler
                                    </button>
                                    <button
                                        class="inline-flex items-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
                                        onclick="window.open('mailto:{{ $suivi->client->email }}')">
                    ...
                    <div class="col-span-full place-items-center">
                        <div class="px-6 py-12 text-center text-gray-500 bg-white rounded-md shadow-sm">
                            <div class="flex flex-col items-center justify-center space-y-2">
                                ...
                                <span class="text-lg font-semibold">Aucune Suivi trouvée</span>
                                <p class="text-sm text-gray-400">Essayez d’ajouter une nouvelle suivi pour commencer.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50"
        style="backdrop-filter: blur(4px);" wire:ignore>
        <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 transform transition-all duration-300 scale-95"
            id="editModalContent">
            <!-- Modal Header -->
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="date" wire:model="editDateSuivi" id="editDateSuivi"
                ...
                <div>
                    ...
                    <textarea wire:model="editNote" id="editNote" rows="4"
