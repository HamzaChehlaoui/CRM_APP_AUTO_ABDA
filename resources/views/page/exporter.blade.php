                ...
                <header class="bg-white shadow-sm border-b border-gray-200 py-6 px-8">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <div
                                class="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg">
                            ...
                            <div>
                                <h1
                                    ...
                                    Exporter</h1>
                                <p class="text-sm text-gray-500 mt-1">Exportez vos données dans différents formats avec
                                    précision</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex-1 p-8 overflow-y-auto">
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div class="space-y-3">
                                <label for="dataType" class="block text-sm font-semibold text-gray-700">Type de
                                    données</label>
                            ...
                            <div class="space-y-3">
                                <label for="exportFormatSelector" class="block text-sm font-semibold text-gray-700">Format
                                    d'exportation</label>
                            ...
                            @if (auth()->user()->role_id == 1 || auth()->user()->role_id == 2)
                                <div class="space-y-3">
                                    <label for="branch_id" class="block text-sm font-semibold text-gray-700">Filtrer par
                                        branche</label>
                                    <select name="branch_id" id="branch_id"
                                        class="w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 bg-white">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        <label for="startDate" class="block text-xs text-gray-500 mb-1">Date de
                                            début</label>
                                        <input type="date" id="startDate"
                                            class="w-full px-3 py-2 border border-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white text-sm">
                                    </div>
                                    <div>
                        ...
                        <div class="flex justify-between items-center mb-8">
                            ...
                            <div class="flex space-x-3">
                                <button id="selectAllBtn" type="button"
                                    class="px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg text-sm font-medium hover:from-blue-600 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5">Tout
                                    sélectionner</button>
                                <button id="deselectAllBtn" type="button"
                                    class="px-5 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 hover:border-gray-300 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5">Tout
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                @foreach ($clientFields as $field => $label)
                                    <label
                                        ...
                                        <input type="checkbox" name="clients.{{ $field }}"
                        ...
                        <div id="fields-cars" class="export-fields space-y-4 mt-6 hidden">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                @foreach ($carFields as $field => $label)
                                    <label
                                        class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                        <input type="checkbox" name="cars.{{ $field }}"
                                            class="h-5 w-5 rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                                        <span class="text-sm font-medium text-gray-800">{{ $label }}</span>
                                    </label>
                                @endforeach
                        ...
                        <div id="fields-invoices" class="export-fields space-y-4 mt-6 hidden">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                @foreach ($invoiceFields as $field => $label)
                                    <label
                                        class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                                        <input type="checkbox" name="invoices.{{ $field }}"
                                            class="h-5 w-5 rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                                        <span class="text-sm font-medium text-gray-800">{{ $label }}</span>
                                    </label>
                                @endforeach
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                        ...
                        <button type="button" id="startExportBtn"
                            class="w-full group relative overflow-hidden bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-6 hover:from-green-600 hover:to-green-700 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
