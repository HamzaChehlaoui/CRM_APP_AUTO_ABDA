            ...
            <div>
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                    ...
                    <button wire:click="showClientsList"
                        class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-gray-600 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors">
                        ...
                        <div
                            ...
                            <div class="p-4 pb-3">
                                <div class="flex items-start justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <h3 class="text-base font-semibold text-gray-900">{{ $client->full_name }}
                                            </h3>
                                ...
                                <div class="px-4 py-3 bg-blue-50 border-t border-blue-100">
                                    ...
                                    <div class="grid grid-cols-2 gap-2 text-xs">
                                        <div>
                                            ...
                                            <p class="font-medium text-gray-900">{{ $car->brand }}
                                                {{ $car->model }}</p>
                                        </div>
                                        <div>
                                    ...
                                    <div class="mt-2 pt-2 border-t border-blue-200">
                                        <div class="grid grid-cols-1 gap-1 text-xs">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="font-mono text-gray-900 ml-2">{{ $car->chassis_number }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="px-4 py-3 bg-green-50 border-t border-green-100">
                                <div class="flex items-center mb-2">
                                    ...
                                    <h4 class="font-medium text-gray-900 text-sm">Facture
                                        ({{ $invoice->statut_facture }})</h4>
                                </div>
                                <div class="grid grid-cols-2 gap-2 text-xs">
                                    <div>
                                ...
                                <div class="mt-2 pt-2 border-t border-green-200">
                                    <div class="grid grid-cols-2 gap-1 text-xs">
                                        ...
                                        <div>
                                            ...
                                            <span
                                                class="text-gray-900 ml-1">{{ $invoice->purchase_order_number }}</span>
                                        </div>
                                        <div>
                                            <span class="text-gray-600">Bon livraison:</span>
                                            <span
                                                class="text-gray-900 ml-1">{{ $invoice->delivery_note_number }}</span>
                                        </div>
                                        <div>
                                            <span class="text-gray-600">Ordre de réparation:</span>
                                            <span
                                                class="text-gray-900 ml-1">{{ $invoice->payment_order_reference }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm">
            <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-lg mx-4 border border-gray-100">
                ...
                <form wire:submit.prevent="updateClient">
                    <div class="space-y-5">
                        <div class="group">
                            <label for="full_name" class="block text-sm font-semibold text-gray-800 mb-2">Full
                                Name</label>
                        ...
                        <div class="group">
                            <label for="email" class="block text-sm font-semibold text-gray-800 mb-2">Email
                                Address</label>
                        ...
                        <div class="group">
                            <label for="phone" class="block text-sm font-semibold text-gray-800 mb-2">Phone
                                Number</label>
                        ...
                        <div class="group">
                            <label for="address"
                                class="block text-sm font-semibold text-gray-800 mb-2">Address</label>
                        ...
                        <div class="group">
                            <label for="cin" class="block text-sm font-semibold text-gray-800 mb-2">National ID
                                (CIN)</label>
