                        ...
                        <div class="mb-6">
                            <div class="bg-white rounded-xl shadow-card p-4">
                                <form method="GET" action="{{ route('dashboard') }}" class="flex items-center gap-4">
                                    <label for="branch_filter" class="text-sm font-medium text-gray-700">Filtrer par
                                        succursale:</label>
                                    ...
                                    <div id="loading-indicator" class="hidden">
                                        <svg class="animate-spin h-5 w-5 text-nucleus-primary"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-xl shadow-card p-6 col-span-3">
                            <div class="flex justify-between items-center mb-8">
                                ...
                                <a href="/clients"
                                    class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-all duration-200 shadow-sm hover:shadow-md">
                                    Voir tout
                                </a>
                            </div>
                                            ...
                                            @forelse ($clients as $client)
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-900">{{ $client->email ?? '—' }}
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="6"
                                                        ...
                                                        <div class="flex flex-col items-center justify-center space-y-3">
                                                            ...
                                                            <h2 class="text-xl font-semibold text-gray-700">Aucun client
                                                                trouvé</h2>
                                                            <p class="text-sm text-gray-400">Ajoutez un nouveau client pour
                                                                commencer à remplir la base de données.</p>
