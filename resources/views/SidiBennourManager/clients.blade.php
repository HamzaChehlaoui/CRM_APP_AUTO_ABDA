        ...
        <aside class="w-64 bg-white shadow-md flex flex-col z-10">
            ...
            <div class="p-4">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="/clientsSidiBennour" class="flex items-center py-2 px-3 rounded-md bg-nucleus-light text-nucleus-primary font-medium ">
                    ...
                    <a href="/statistiquesSidiBennour" class="flex items-center py-2 px-3 rounded-md hover:bg-nucleus-light hover:text-nucleus-primary font-medium transition-colors duration-200">
