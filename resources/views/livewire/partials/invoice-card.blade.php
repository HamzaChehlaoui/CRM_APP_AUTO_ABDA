        ...
        <div class="flex items-center justify-between">
            ...
            @if(auth()->user()->role_id!=1 && auth()->user()->role_id!=2 )
                <a href="{{ route('invoices.edit', $invoice->id) }}"
                   class="inline-flex items-center justify-center w-9 h-9 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 transition-colors duration-200 shadow-sm">
